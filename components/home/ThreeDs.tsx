    ...
    <section id="threeds" className="bg-white py-20 sm:py-28" data-threeds>
      <Container size="wide">
        ...
        <div className="relative mt-16">
          ...
          <div
            aria-hidden
            className="absolute left-0 right-0 top-[3.25rem] hidden h-px bg-gradient-to-r from-grad-from/30 via-purple/40 to-grad-to/30 lg:block"
          />
            ...
            {threeDs.map((step, i) => {
              ...
              return (
                <Reveal key={step.key} delay={i * 120}>
                  <div className="group relative" data-threeds-step>
