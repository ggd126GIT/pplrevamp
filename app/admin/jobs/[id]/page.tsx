      ...
      <div className="mt-8">
        <JobForm
          ...
          values={{
            ...
            // Show the effective posted date, so an editor sees what the page
            // actually renders rather than an empty field.
            posted_at: toDateTimeInput(job.posted_at ?? job.created_at),
          }}
        />
      </div>
    </div>
